<%-- 
    Document   : livre-list
    Created on : May 17, 2024, 1:06:01 a.m.
    Author     : asma
--%>
				...
				<tbody>
					...
					<c:forEach var="livre" items="${listLivre}">
						...
						<tr>
							...
							<td><c:out value="${livre.disponible}" /></td>
							<td><a href="edit?id=<c:out value='${livre.idLivre}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?id=<c:out value='${livre.idLivre}' />">Delete</a></td>
						</tr>
					</c:forEach>
